              ...
              function (e, t) {
                S.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (R[e] || S.uniqueSort(i), P.test(e) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              }
                  ...
                  i = {
                    ...
                    then: function (e, n, i) {
                      ...
                      return S.Deferred(function (r) {
                        t[0][3].add(a(0, r, m(i) ? i : I, r.notifyWith)),
                          t[1][3].add(a(0, r, m(e) ? e : I)),
          ...
          S.ajaxSetup({
            ...
            S.each(["top", "left"], function (e, t) {
              S.cssHooks[t] = Ue(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = ze(e, t)), We.test(n) ? S(e).position()[t] + "px" : n
                  );
              });
            }),
  ...
  (() => {
    ...
    function a(e) {
      ...
      function g() {
        (f = t()(i)),
          (function (e, r, i, a) {
            let s = `${e}/api_comments.php?site_key=${r}`;
            i && (s += "&before=" + i),
              t()
                .ajax({ url: s })
                .done((e) => {
                  e.ok
                    ? ((e) => {
                        d = e.count;
                        const r = e.discussions;
                        for (let e of r) o(f, e);
                        let i = r.length;
                        if (((h += 5), h >= d)) t()(`.${n}`).hide();
                        else {
                          p = r[i - 1].id;
                          const e = `<button class="${n} btn btn-primary mt-3 mb-3 more-comments-btn" type="button">載入更多</button>`;
                          f.append(e);
                        }
                      })(e)
                    : alert(e.message);
      ...
      (l = e.siteKey),
        ...
        (n = `${l}-load-more`),
        (r = `${l}-comments`),
        (a = `${l}-add-comment-form`),
        (i = `.${r}`),
        (s = `.${a}`),
        (c = t()(e.containerSelector)),
        c.append(
          (function (e, t) {
        ...
        t()(s).submit((e) => {
          e.preventDefault();
          const n = t()(`${s} input[name=nickname]`),
            r = t()(`${s} textarea[name=content]`),
            i = t()(`${s} button[type=submit]`);
          i.attr("disabled", "true");
          const a = { site_key: l, nickname: n.val(), content: r.val() };
          !(function (e, s, u, l) {
            t()
              .ajax({
                method: "POST",
                url: `${e}/api_add_comments.php`,
                data: u,
              })
              .done((e) => {
                ((e) => {
                  if (!e.ok)
                    return (
                      alert(e.message),
                      void setTimeout(i.removeAttr("disabled"), 3e3)
                    );
                  n.val(""),
                    r.val(""),
                    o(f, a, !0),
                    setTimeout(i.removeAttr("disabled"), 3e3);
                })(e);
              });
          })(u, 0, a);
        });
